...
outFileName=inputFilesConfig+str(nstart)
process.TFileService = cms.Service("TFileService",
        fileName = cms.string(outFileName+"_.root")
)
...
copy11="xrdcp  root://cmseos.fnal.gov//store/user/bmahakud/JECFiles/PhaseIIFall17_V2_MC_L2Relative_AK4PUPPI.txt ."
...
process.AK8Jets = cms.EDProducer("JetProducer",
    ...
    jecPayloadsAK4pup = cms.vstring([
                                    ...
                                    jecfile+'PhaseIIFall17_V2_MC_L2Relative_AK4PUPPI.txt',
